...
import com.appupdate.utils.Constant;
...
public class HttpDownloadManager extends BaseHttpDownloadManager {
    ...
    private void breakpointDownload() {
        ...
        try {
            ...
            SharePreUtil.putString(DownloadManager.getContext(), "APK_LENGTH", length+"");
            ...
            if (con.getResponseCode() == HttpURLConnection.HTTP_PARTIAL) {
                ...
                if (accessFile != null) {
                    ...
                    SharePreUtil.putString(DownloadManager.getContext(), "APK_DOWN_DONE", downloadPath+"/"+apkName);
